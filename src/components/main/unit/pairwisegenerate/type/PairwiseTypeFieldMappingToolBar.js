...
import styles from './PairwiseTypeFieldMappingToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class PairwiseTypeFieldMappingToolBar extends Component {
  ...
  render() {
    return (
      <div className={cx('pairwise-type-field-mapping-tool-bar')}>
...
export default PairwiseTypeFieldMappingToolBar;
