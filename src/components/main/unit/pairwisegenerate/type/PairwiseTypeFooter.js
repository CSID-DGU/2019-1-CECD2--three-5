...
import styles from './PairwiseTypeFooter.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class PairwiseTypeFooter extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div className = {cx('pairwise-type-footer')}>
...
export default PairwiseTypeFooter;
