...
import GenerationDetailEditInputTemplate from './GenerationDetailEditInputTemplate'
...
class GenerationDetailEditTemplate extends Component {
     ...
     render() {
        ...
        const{loading, colsize} = this.props;

        const testCaseData = mockData;
        ...
        return (
            <Col xl={colsize} >
            <GenerationDetailEditInputTemplate/>
