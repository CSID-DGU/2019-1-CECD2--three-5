...
import styles from './PairwiseGenerationResultsToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class PairwiseGenerationResultsToolBar extends Component {
  ...
  render() {
    return (
      <div className={cx('pairwise-generation-results-tool-bar')}>
...
export default PairwiseGenerationResultsToolBar;
