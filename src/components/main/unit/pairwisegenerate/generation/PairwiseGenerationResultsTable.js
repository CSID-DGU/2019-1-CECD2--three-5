...
import styles from "./PairwiseGenerationResultsTable.scss";
import classNames from "classnames/bind";
const cx = classNames.bind(styles);

class PairwiseGenerationResultsTable extends Component {
  constructor(props) {
    super(props);
            ...
            <ToolkitProvider keyField="fieldOne" data={testcaseListInfo} columns={this.columns} search>
              {props => (
                <div>
                  ...
                  <PairwiseGenerationResultsToolBar
                    {...this.state}
                    ...
                    className="pairwise-generation-results-tool-bar"
                  />
                  <BootstrapTable
                    {...props.baseProps}
                    {...this.state}
...
export default withRouter(PairwiseGenerationResultsTable);
