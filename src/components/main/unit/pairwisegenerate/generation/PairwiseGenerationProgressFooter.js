...
import styles from'./PairwiseGenerationProgressFooter.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class PairwiseGenerationProgressFooter extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    return(
      <div className="pairwise-generation-progress-footer">
...
export default withRouter(PairwiseGenerationProgressFooter);
