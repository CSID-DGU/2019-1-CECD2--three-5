...
import './PairwiseGenerationSideMenu.scss';

class PairwiseGenerationSideMenu extends Component {
  ...
  render() {
    return (
      <Col md={2} className="pairwise-generation-side-menu">
...
export default PairwiseGenerationSideMenu;
