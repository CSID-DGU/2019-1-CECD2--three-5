...
import PairwiseGenerationResultsTable from 'components/main/unit/pairwisegenerate/generation/PairwiseGenerationResultsTable';
import PairwiseGenerationResultInformationTemplate from 'components/main/unit/pairwisegenerate/generation/PairwiseGenerationResultInformationTemplate';
import PairwiseGenerationResultsToolBar from 'components/main/unit/pairwisegenerate/generation/PairwiseGenerationResultsToolBar';
import ListCountNavigation from 'components/common/policy/ListCountNavigation';
import styles from'./PairwiseGenerationResultsTemplate.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class PairwiseGenerationResultsTemplate extends Component {
  constructor(props) {
    super(props);
  ...
  remoteViewResultsList = (pageNum, pageCnt, generationNo, executionProjectNo, methodNo) => {
    const url = '/pairwiseGeneration/viewPairwiseGenerationTestcaseList/1';

    console.log("1111::executionUuid", this.props.executionUuid);
    ...
    const data = {
      params: {
        ...
        executionProjectNo: executionProjectNo,
        methodNo: methodNo
       }
    };
  ...
  render() {
    ...
    return(
      <div className = 'pairwise-generate-result-template'>
        <div>
          <PairwiseGenerationResultInformationTemplate {...this.state}
        ...
        {this.state.testcaseListInfo != null && <PairwiseGenerationResultsTable {...this.state}
...
export default withRouter(PairwiseGenerationResultsTemplate);
