...
import styles from './RandomAlgorithmRegisterToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomAlgorithmRegisterToolBar extends Component {
  ...
  render() {
    return (
      <div className={cx('random-algorithm-register-tool-bar')}>
...
export default RandomAlgorithmRegisterToolBar;
