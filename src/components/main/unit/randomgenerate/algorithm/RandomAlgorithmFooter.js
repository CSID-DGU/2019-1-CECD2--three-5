...
import styles from './RandomAlgorithmFooter.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomAlgorithmFooter extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div className = {cx('random-algorithm-footer')}>
...
export default RandomAlgorithmFooter;
