...
import styles from './RandomFieldToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomFieldToolBar extends Component {
  ...
  render() {
    return (
      <div className ={cx('random-field-tool-bar')}>
...
export default RandomFieldToolBar;
