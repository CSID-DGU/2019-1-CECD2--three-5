/**
 * 작성자: 김지운, 원예인
 * 설명: 필드유형 등록 react-bootstrap-table들을 이용하는 테이블들의 하단 페이징 처리
**/
import React, {Component} from 'react';

import ProjectListPagenation from 'components/common/project/ProjectPagenation';

import styles from './RandomFieldFooter.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomFieldFooter extends Component {
  constructor(props) {
    super(props);
  }
  ...
  render() {
    ...
    return (
      <div className = {cx('random-field-footer')}>
...
export default RandomFieldFooter;
