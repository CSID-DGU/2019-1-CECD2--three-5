...
import MappingTable from './RuleFieldMappingTable';
import { faAngleDown } from '@fortawesome/free-solid-svg-icons'
import { FontAwesomeIcon } from '@fortawesome/react-fontawesome'
import { faAngleUp } from '@fortawesome/free-solid-svg-icons'


import './RuleFieldMappingTab.scss'

class RuleFieldMappingTab extends Component{
    constructor(props){
        super(props);
        this.state={
...
export default RuleFieldMappingTab;