...
import styles from './RandomGenerationResultsToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomGenerationResultsToolBar extends Component {
  ...
  render() {
    return (
      <div className={cx('random-generation-results-tool-bar')}>
...
export default RandomGenerationResultsToolBar;
