...
import styles from './RandomGenerationHistoryTable.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomGenerationHistoryTable extends Component {
    constructor(props) {
        super(props);
        ...
        const randomGenHistList = this.props.randomGenHistList;
        const selectedList = [];
                  ...
                  {props => (
                    <div>
                      ...
                      <RandomGenerationToolBar
                        ...
                        className="random-generation-tool-bar"
                      />
                      <BootstrapTable
                        {...props.baseProps}
                        {...this.state}
...
export default RandomGenerationHistoryTable;
