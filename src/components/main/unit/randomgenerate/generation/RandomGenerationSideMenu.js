...
import './RandomGenerationSideMenu.scss';

class RandomGenerationSideMenu extends Component {
  ...
  render() {
    return (
      <Col md={2} className="random-generation-side-menu">
...
export default RandomGenerationSideMenu;
