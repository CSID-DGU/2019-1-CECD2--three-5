...
import styles from './RandomGenerationToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomGenerationToolBar extends Component {
  ...
  render() {
    return (
      <div className={cx('random-generation-tool-bar')}>
...
export default RandomGenerationToolBar;
