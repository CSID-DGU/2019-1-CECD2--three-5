...
import styles from './RandomRuleParameterEditToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomRuleParameterEditToolBar extends Component {
  ...
  render() {
    return (
      <div className ={cx('random-rule-parameter-edit-tool-bar')}>
...
export default RandomRuleParameterEditToolBar;
