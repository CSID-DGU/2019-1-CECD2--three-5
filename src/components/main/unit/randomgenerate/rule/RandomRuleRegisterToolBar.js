...
import styles from './RandomRuleRegisterToolBar.scss';
import classNames from 'classnames/bind';
const cx = classNames.bind(styles);

class RandomRuleRegisterToolBar extends Component {
  ...
  render() {
    return (
      <div className ={cx('random-rule-register-tool-bar')}>
...
export default RandomRuleRegisterToolBar;
